...
model_transformer.load_state_dict(torch.load('/home/adilfaisal01/Downloads/results_sweep1/workspace/outputs/fixed_models/model_dlenfinetune_1e-3_0.2_big_epoch200.pth',map_location=dev))
## loading the dataset
